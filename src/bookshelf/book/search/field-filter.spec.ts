...
test.each([
    ...
    ['It should match exact author', new FieldFilter('author', 'Joe Schmoe'), true],
    ['It should match exact author (link)', new FieldFilter('author', 'J. Doe'), true],
    ['It must not match partial author', new FieldFilter('author', 'Joe'), false],
    ['It must not match partial author (link)', new FieldFilter('author', 'Doe'), false],
